    ...
    <div className={page === "docs" ? "launch-site docs-open" : "launch-site"}>
      <div className="hop-net" aria-hidden="true">
        <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
          ...
          />
          <circle className="hop-net-node" cx="110" cy="200" r="3.2" />
          <circle className="hop-net-node hop-net-hop" cx="720" cy="310" r="5.5" />
          <circle className="hop-net-node" cx="1330" cy="270" r="3.2" />
          <circle className="hop-net-node" cx="70" cy="680" r="3.2" />
          <circle className="hop-net-node hop-net-hop delay" cx="760" cy="610" r="5.5" />
          <circle className="hop-net-node" cx="1370" cy="620" r="3.2" />
          <circle className="hop-net-packet a" r="3.4" />
          <circle className="hop-net-packet b" r="3" />
        </svg>
      </div>
